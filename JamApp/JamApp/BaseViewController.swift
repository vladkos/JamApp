...
class BaseViewController: UIViewController, SlideMenuDelegate {
    ...
    func slideMenuItemSelectedAtIndex(_ index: Int32) {
        ...
        switch(index){
        case 0:
            print("RecipesViewController\n", terminator: "")
            
            self.openViewControllerBasedOnIdentifier("RecipesViewController")
            
            break
        case 1:
            print("Categories\n", terminator: "")
            
            self.openViewControllerBasedOnIdentifier("Categories")
        ...
        case 4:
            ...
            self.openViewControllerBasedOnIdentifier("AboutProject")
